...
public class AnyService {
	...
	@Test
	public void findByMongoTemplate() {
	...
	@Test
	public void findByMongoRepositoryWithQuery() {
		List<AnyEntity> anyEntities = anyRepository.findByName("Chen");
		System.out.println(anyEntities);
	}
	
	@Test
	public void findByMongoRepositoryWithoutQuery() {
		List<AnyEntity> anyEntities = anyRepository.findByGender("M");
		System.out.println(anyEntities);
	}
}
